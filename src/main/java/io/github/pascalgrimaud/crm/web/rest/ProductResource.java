...
import io.github.pascalgrimaud.crm.service.ProductService;
...
/**
 * REST controller for managing {@link io.github.pascalgrimaud.crm.domain.Product}.
 */
@RestController
@RequestMapping("/api")
public class ProductResource {
    ...
    public ResponseEntity<Product> partialUpdateProduct(@NotNull @RequestBody Product product) throws URISyntaxException {
