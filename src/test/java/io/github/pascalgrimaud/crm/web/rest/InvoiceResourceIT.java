...
import static io.github.pascalgrimaud.crm.web.rest.TestUtil.sameNumber;
...
import io.github.pascalgrimaud.crm.domain.enumeration.InvoiceStatus;
import io.github.pascalgrimaud.crm.domain.enumeration.PaymentMethod;
import io.github.pascalgrimaud.crm.repository.InvoiceRepository;
...
class InvoiceResourceIT {
    ...
    @Test
    @Transactional
    void updateNonExistingInvoice() throws Exception {
        int databaseSizeBeforeUpdate = invoiceRepository.findAll().size();
    ...
    void partialUpdateInvoiceWithPatch() throws Exception {
        ...
        partialUpdatedInvoice.code(UPDATED_CODE).date(UPDATED_DATE).details(UPDATED_DETAILS).paymentAmount(UPDATED_PAYMENT_AMOUNT);
    ...
    @Test
    @Transactional
    void partialUpdateInvoiceShouldThrown() throws Exception {
        // Update the invoice without id should throw
        Invoice partialUpdatedInvoice = new Invoice();
    ...
    void deleteInvoice() throws Exception {
        ...
        // Delete the invoice
        restInvoiceMockMvc
            .perform(delete("/api/invoices/{id}", invoice.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
