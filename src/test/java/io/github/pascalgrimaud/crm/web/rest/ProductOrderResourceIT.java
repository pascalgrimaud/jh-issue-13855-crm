...
import io.github.pascalgrimaud.crm.domain.enumeration.OrderStatus;
import io.github.pascalgrimaud.crm.repository.ProductOrderRepository;
...
class ProductOrderResourceIT {
    ...
    void getAllProductOrders() throws Exception {
        ...
        restProductOrderMockMvc
            .perform(get("/api/product-orders?sort=id,desc"))
    ...
    void getProductOrder() throws Exception {
        ...
        restProductOrderMockMvc
            .perform(get("/api/product-orders/{id}", productOrder.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    void getNonExistingProductOrder() throws Exception {
        // Get the productOrder
        restProductOrderMockMvc.perform(get("/api/product-orders/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    @Test
    @Transactional
    void updateNonExistingProductOrder() throws Exception {
        int databaseSizeBeforeUpdate = productOrderRepository.findAll().size();
    ...
    @Test
    @Transactional
    void partialUpdateProductOrderShouldThrown() throws Exception {
        // Update the productOrder without id should throw
        ProductOrder partialUpdatedProductOrder = new ProductOrder();
    ...
    void deleteProductOrder() throws Exception {
        ...
        restProductOrderMockMvc
            .perform(delete("/api/product-orders/{id}", productOrder.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
