...
import io.github.pascalgrimaud.crm.domain.enumeration.Size;
import io.github.pascalgrimaud.crm.repository.ProductRepository;
...
class ProductResourceIT {
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.price(UPDATED_PRICE).image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE);
    ...
    void deleteProduct() throws Exception {
        ...
        // Delete the product
        restProductMockMvc
            .perform(delete("/api/products/{id}", product.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
