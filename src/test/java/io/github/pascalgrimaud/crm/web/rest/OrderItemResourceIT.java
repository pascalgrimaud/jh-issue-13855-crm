...
class OrderItemResourceIT {
    ...
    @Test
    @Transactional
    void updateNonExistingOrderItem() throws Exception {
        int databaseSizeBeforeUpdate = orderItemRepository.findAll().size();
    ...
    @Test
    @Transactional
    void partialUpdateOrderItemShouldThrown() throws Exception {
        // Update the orderItem without id should throw
        OrderItem partialUpdatedOrderItem = new OrderItem();
    ...
    void deleteOrderItem() throws Exception {
        ...
        restOrderItemMockMvc
            .perform(delete("/api/order-items/{id}", orderItem.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
